...
urlpatterns = [
    ...
    path('gateway-type', views.GatewayTypeView.as_view(),
         name='gateway_type_endopoint'),
    ...
    path('delete-gateway-url', views.DeleteGatewayUrlView.as_view(),
         name='delete_gateway_url'),
